"""
Training script for reranker model fine-tuning.
"""
...
from src.evaluation.metrics import RerankerEvaluator
import json
...
def main():
    ...
    parser.add_argument('--config', type=str, default='configs/reranker_config.yaml',
    ...
    train_examples = dataset_loader.prepare_reranker_data(dataset)
    ...
    training_info = trainer.fine_tune(
        ...
        evaluation_steps=config.get('evaluation_steps', 500),
    ...
    evaluator = RerankerEvaluator(trainer)
    eval_results = evaluator.evaluate_ranking(
    ...
    print("Reranker model training completed successfully!")
